...
const { generateDevHTMLWebpackPlugin } = require('./generateConfiguration');
...
const cssFilename = 'static/[name]/css/[name].[contenthash:8].css';
...
module.exports = {
  ...
  output: {
    ...
    filename: 'static/[name]/js/[name].[chunkhash:8].js',
  ...
  plugins: [
    ...generateDevHTMLWebpackPlugin('prod'),
